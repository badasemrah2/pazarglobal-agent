...
class ResponseBuilder:
    ...
    MESSAGES = {
        ...
        "listing_need_images": "📸 Ürününüzün fotoğrafını gönderin.",
        "listing_need_description": "📝 Ürün açıklaması eklemek ister misiniz? (isteğe bağlı, 'geç' yazabilirsiniz)",
        "listing_need_condition": "📦 Ürünün durumu nedir? (sıfır/az kullanılmış/iyi/yıpranmış)",
        "listing_need_location": "📍 Neredesiniz? (şehir)",
